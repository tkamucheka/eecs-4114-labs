...
proc write_mig_file_base_soc_mig_7series_0_0 { str_mig_prj_filepath } {
   ...
   puts $mig_prj_file {  <ModuleName>base_soc_mig_7series_0_0</ModuleName>}
   ...
   puts $mig_prj_file {    <NewPartName>MT41K128M16XX-125</NewPartName>}
...
proc create_root_design { parentCell } {
  ...
  # Create instance: microblaze_0_smartconnect, and set properties
  set microblaze_0_smartconnect [ create_bd_cell -type ip -vlnv xilinx.com:ip:smartconnect:1.0 microblaze_0_smartconnect ]
  set_property -dict [ list \
   CONFIG.NUM_MI {2} \
   CONFIG.NUM_SI {1} \
 ] $microblaze_0_smartconnect
  ...
  connect_bd_intf_net -intf_net microblaze_0_M_AXI_DP [get_bd_intf_pins microblaze_0/M_AXI_DP] [get_bd_intf_pins microblaze_0_smartconnect/S00_AXI]
  ...
  connect_bd_intf_net -intf_net microblaze_0_periph_M00_AXI [get_bd_intf_pins axi_uart16550_0/S_AXI] [get_bd_intf_pins microblaze_0_periph/M00_AXI]
  connect_bd_intf_net -intf_net microblaze_0_smartconnect_M00_AXI [get_bd_intf_pins microblaze_0_mem/S00_AXI] [get_bd_intf_pins microblaze_0_smartconnect/M00_AXI]
  connect_bd_intf_net -intf_net microblaze_0_smartconnect_M01_AXI [get_bd_intf_pins microblaze_0_periph/S00_AXI] [get_bd_intf_pins microblaze_0_smartconnect/M01_AXI]
  ...
  connect_bd_net -net microblaze_0_Clk [get_bd_pins axi_uart16550_0/s_axi_aclk] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins microblaze_0_mem/aclk] [get_bd_pins microblaze_0_periph/aclk] [get_bd_pins microblaze_0_smartconnect/aclk] [get_bd_pins mig_7series_0/ui_clk] [get_bd_pins rst_mig_7series_0_83M/slowest_sync_clk]
  ...
  connect_bd_net -net reset_1 [get_bd_ports reset] [get_bd_pins clk_wiz_0/resetn] [get_bd_pins mig_7series_0/sys_rst] [get_bd_pins rst_mig_7series_0_83M/ext_reset_in]
  ...
  connect_bd_net -net rst_mig_7series_0_83M_interconnect_aresetn [get_bd_pins microblaze_0_mem/aresetn] [get_bd_pins microblaze_0_periph/aresetn] [get_bd_pins microblaze_0_smartconnect/aresetn] [get_bd_pins rst_mig_7series_0_83M/interconnect_aresetn]
  ...
  connect_bd_net -net rst_mig_7series_0_83M_peripheral_aresetn [get_bd_pins axi_uart16550_0/s_axi_aresetn] [get_bd_pins mig_7series_0/aresetn] [get_bd_pins rst_mig_7series_0_83M/peripheral_aresetn]
