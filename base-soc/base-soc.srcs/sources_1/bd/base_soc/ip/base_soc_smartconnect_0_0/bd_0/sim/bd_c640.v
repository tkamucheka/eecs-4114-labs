...
(* CORE_GENERATION_INFO = "bd_c640,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_c640,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=17,numReposBlks=13,numNonXlnxBlks=0,numHierBlks=4,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=Global}" *) (* HW_HANDOFF = "base_soc_smartconnect_0_0.hwdef" *) 
module bd_c640
   (M00_AXI_araddr,
    M00_AXI_arburst,
    M00_AXI_arcache,
