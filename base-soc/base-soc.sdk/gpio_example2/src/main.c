...
int main(void)
{
  ...
  volatile unsigned *rgbLEDData = (unsigned *)(XPAR_AXI_GPIO_1_BASEADDR);
  volatile unsigned *rgbLEDTri = (unsigned *)(XPAR_AXI_GPIO_1_BASEADDR + 4);

  // Initialize dip switch GPIO
  volatile unsigned *dipSWData = (unsigned *)(XPAR_AXI_GPIO_1_BASEADDR + 8);
